...
This repository contains my personal portfolio website and documents my journey as I learn full-stack web development.

## Development Log

### 6/23/2026

* Started building the landing/home page of my portfolio.
* Learned and practiced semantic HTML elements such as `header`, `main`, `section`, `figure`, and `footer`.
* Made my first push to GitHub.
